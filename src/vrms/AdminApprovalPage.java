...
public class AdminApprovalPage extends JFrame {
    ...
    private JPanel createHeader() {
        ...
        JLabel subtitle = new JLabel("Review listings before they enter the public catalog");
    ...
    private JPanel createBottomBar() {
        ...
        refresh.addActionListener(e -> loadPendingVehicles());

        JButton back = createPrimaryButton("Back to Admin Catalog");
